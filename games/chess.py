...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (8, 8, 119)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        ...
        self.max_moves = 5949  # Maximum number of moves if game is not finished before
        ...
        self.resnet_fc_reward_layers = [256, 265]  # Define the hidden layers in the reward head of the dynamic network
        self.resnet_fc_value_layers = [265, 265]  # Define the hidden layers in the value head of the prediction network
        self.resnet_fc_policy_layers = [265, 265]  # Define the hidden layers in the policy head of the prediction network
